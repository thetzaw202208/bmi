                                  ...
                                  child: Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        //   child: Image.asset(
                                        //       "assets/images/${value.sellerType?[index].id}.png"),
                                        // ),
                                        Padding(
                                          padding: const EdgeInsets.symmetric(
                                              horizontal: 38.0, vertical: 5),
                                          child: Image.network(value.sellerType?[index].photo?.originalUrl??""),
                                        ),
                                        ReusableText(
                                          reuseText:
                                              value.sellerType?[index].name,
                                          fWeight: FontWeight.bold,
                                          fSize: kFontSize13,
              ...
              child: ReusableButton(
                onTap: () async {
                  ...
                  if (value.selectedIndex != null) {
                    sh.setString("sellerType",
                        value.sellerType?[value.selectedIndex ?? 0].name ?? "");
